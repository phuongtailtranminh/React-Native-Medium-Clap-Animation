# React-Native-Medium-Clap-Animation
The mimic of Medium Clap Button effect
...
![alt text](https://github.com/phuongtailtranminh/React-Native-Medium-Clap-Animation/blob/master/images/screenshot.jpg?raw=true|width=200)
